        ...
        {adminNav.map((item, idx) => (
          ...
          >
            <NavLink
              to={item.path}
              className={({ isActive }) =>
                `text-center text-white py-2 px-4 rounded-lg block hover:bg-gray-700 transition-all duration-200 ${isActive ? "bg-green-600 text-white font-bold" : "text-gray-300"
                }`
              }
            >{item.title}
            </NavLink>
